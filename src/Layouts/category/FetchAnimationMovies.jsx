...
const FetchAnimationMovies = ({ fetchAnimationMovies }) => {

    const ImageAPI = useContext(UserContext);

    return (
        <>
            <div className="columns" id="animation">
                <div className="column cat-icons">
                    <FcFlashOn /> <i>Animation Movies</i>
                </div>
...
export default FetchAnimationMovies