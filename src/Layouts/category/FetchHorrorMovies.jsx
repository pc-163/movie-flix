...
const FetchHorrorMovies = ({ fetchHorrorMovies }) => {

    const ImageAPI = useContext(UserContext);

    return (
        <>
            <div className="columns" id="horror">
                <div className="column cat-icons">
                    <FcFlashOn /> <i>Horror Movies</i>
                </div>
...
export default FetchHorrorMovies